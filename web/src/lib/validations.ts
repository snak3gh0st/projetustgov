...
export const CreateUsuarioSchema = z.object({
  ...
  email: z.string().email({ message: 'Email invalido' }),
  password: z.string().min(8, { message: 'Senha deve ter ao menos 8 caracteres' }),
  role: z.enum(['vendedor', 'visualizador', 'coordenador', 'adm_produto', 'coord_aprovacao', 'assistente_aprovacao', 'projetista', 'coord_execucao', 'assistente_execucao', 'projetista_execucao']).default('vendedor'),
})
