...
interface Usuario {
  ...
  nome: string
  email: string
  role: 'gestor' | 'coordenador' | 'visualizador' | 'vendedor' | 'adm_produto'
  active: boolean
  created_at: string
  lead_count: number
  is_self: boolean
        ...
        <form action={formAction} className="space-y-6">
          ...
          {isAdmProduto ? (
            <div>
              ...
              <div className="w-full bg-orange-50 border border-orange-200 text-orange-700 px-4 py-3 rounded-lg text-sm font-medium">
                Adm Produto
              </div>
              <input type="hidden" name="role" value="adm_produto" />
            </div>
          ) : (
            <div>
              ...
              >
                ...
                <option value="adm_produto">Adm Produto</option>
              </select>
            </div>
          )}
